...
public class BridgeTest {
    ...
    void emailSend() {
        ...
        assertTrue(out.contains("EMAIL to user@email.com :: pass"));
    }
    ...
    void pushSend() {
        ...
        String out = capture.toString();
        assertTrue(out.contains("PUSH to device_abc :: received"));
    }

    @Test
    void onlineNotification() {
        NotificationChannel email = new EmailChannel();
        PaymentNotification n = new OnlinePaymentNotification(email, "alex@email.com", 129.99, "Credit Card");
        n.notifyCustomer();
        String out = capture.toString();
        assertTrue(out.contains("EMAIL to alex@email.com"));
